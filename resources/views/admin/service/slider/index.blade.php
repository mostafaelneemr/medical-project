        ...
        <div class="col-md-12 ">
            ...
            <div class="card">
                <div class="card-header">
                    <h3> Slider List
                        @if (\app\Models\Slider::where('slider_type' , 'service')->count() == 0)
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('service-slider.destroy', $slider->id)}}" class="btn btn-danger btn-sm" title="Edit" role="button" aria-pressed="true"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
